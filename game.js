...
this.gameStartSound = new Audio('./sounds/game_start.wav');
...
let drawGameOver = () => {
    ...
    canvasContext.fillText("Game Over!", 120, 140);
};

let drawWin = () => {
    canvasContext.font = "18px Emulogic";
    canvasContext.fillStyle = "white";
    canvasContext.fillText("You Win!", 120, 140);
};
...
let drawRemainingLives = () => {
    canvasContext.font = "18px Emulogic";
    canvasContext.fillStyle = "white";
    canvasContext.fillText("Lives: ", 230, oneBlockSize * (map.length + 1.5));
